...
const files=['index.html','multiplayer.html','style.css','atelier.css','data.js','rules.js','idle.js','explore.js','battle-engine.js','combat.js','collection.js','ui.js','room-code.js','strategy.js','card-enemy.jpg','dice-enemy.jpg'];
