...
(function(root) {
    ...
    function normalize(raw) {
        ...
        const t=d.tutorial;d.tutorial={version:1,step:Number.isInteger(t?.step)?Math.max(0,Math.min(4,t.step)):0,complete:t?.complete===true,dismissed:t?.dismissed===true};
        d.towerCompleted=d.towerCompleted===true; d.saveVersion=3;
        return d;
    }
    ...
    const speedCost=d=>Math.floor(15*Math.pow(1.25,d.speedUpgradeCount));
    const valueCost=d=>Math.floor(500*Math.pow(2.5,d.valueUpgradeCount));
